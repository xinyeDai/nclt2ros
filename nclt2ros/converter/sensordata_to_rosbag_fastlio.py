...
def write_vel(f_vel,bag,vel_path):
    size = os.path.getsize(vel_path + "velodyne_hits.bin")
    print(size/28/32)
...
def main(args):
    ...
    gps = np.loadtxt(sys.argv[1] + "/sensor_data/" + sys.argv[1] + "gps.csv", delimiter = ",")
    gps_rtk = np.loadtxt(sys.argv[1] + "/sensor_data/" + sys.argv[1] + "gps_rtk.csv", delimiter = ",")
    ms25 = np.loadtxt(sys.argv[1] + "/sensor_data/" + sys.argv[1] + "ms25.csv", delimiter = ",")
    ms25_euler = np.loadtxt(sys.argv[1] + "/sensor_data/" + sys.argv[1] + "ms25_euler.csv", delimiter = ",")
    ...
    vel_path = sys.argv[1] + "/velodyne_data/" + sys.argv[1]
    f_vel = open(vel_path + "velodyne_hits.bin", "rb")
    print(f_vel)
